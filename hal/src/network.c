/**
 * @file network.c
 * @brief Implementation of the Network HAL.
 */
...
void Network_enable_logging(int enable) { logging_enabled = enable; }
...
int Network_start_server(int port) {
  ...
  // Set Socket Options (Reuse Address/Port to prevent 'Address already in use')
